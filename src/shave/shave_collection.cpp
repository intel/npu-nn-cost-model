...
void ShaveInstanceHolder_NPU50::populate() {
   ...
   //should support insertion of all known operators types
        ...
        {64, 140.9999999999991F, {1.182448036951501F, 0.4923076923076922F, 0.04669260700389106F}}};
         ...
         AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "sigmoid", costFunction3SlopesDataSigmoid, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        {64, 140.99999999999875F, {1.3061224489795917F, 0.5614035087719298F, 0.08053691275167783F}}};
         ...
         AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "add", costFunction3SlopesDataAdd, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "softmax", costFunction3SlopesDataSoftmax, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "gelu", costFunction3SlopesDataGelu, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "hswish", costFunction3SlopesDataHSWISH, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "log", costFunction3SlopesDataLOG, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "mul", costFunction3SlopesDataMUL, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "swish", costFunction3SlopesDataSWISH, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Piecewise<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "tanh", costFunction3SlopesDataTANH, true, MAXBLKNUM, NPU50DSPARCH, NPU50COSTCURVERATIO);
        ...
        AddVPUEM_Softmax<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "softmax_x", costFunctionSoftmaxData);

        // VPUEM Spatial 
 
        const CostFunctionSpatialDescriptor CostFunctionSpatialData = {8, 137, 373, "NHWC", {0.8888888888888889F}};
        AddVPUEM_Spatial<DataType::FLOAT16,1950, 1114>(std::string(opPrefix) + "mvn", CostFunctionSpatialData);


    // clang-format on
}

void ShaveInstanceHolder_HeuristicNPU50::populate() {
    // add concrete instances, generated or by hand
    // clang-format off
    ...
    #include "vpu/shave/shave_heuristic_npu5.inl"
}
