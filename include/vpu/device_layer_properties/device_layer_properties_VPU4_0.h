...
#ifndef LAYER_PROPERTIES_VPU4_0_H
#define LAYER_PROPERTIES_VPU4_0_H
...
/// @brief data holder for VPU 4.0 layer properties.
///
...
struct VPU4_0_LayerPropertiesData {
    ...
    inline static const std::vector<ExecutionMode> dcim_exec_modes{};  ///< no dCIM support for VPU 4.0
...
using VPU4_0_LayerProperties = LayerProperties_All_Devices<TilingExecutionMode<VPU4_0_LayerPropertiesData>,
                                                           DefaultExecutionMode<VPU4_0_LayerPropertiesData>,
                                                           TilingStrategies<VPU4_0_LayerPropertiesData>>;
}  // namespace VPUNN
