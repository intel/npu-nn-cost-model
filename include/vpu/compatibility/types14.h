...
protected:
    using PreprocessingInserter<T, Preprocessing_Interface14_Archetype<T, DeviceAdapter, V>>::
    ...
    inline static const size_t size_of_descriptor{44 + 3 + 3 +
                                                  3};  ///< how big the descriptor is, fixed at constructor.
