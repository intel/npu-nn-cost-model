...
def testDMAPower(
    ...
    single_wl_cycles = model.DMAPower(**wl)
    ...
    assert model.DMAPower(**split_wl) <= single_wl_cycles
    ...
    assert model.DMAPower(**larger_wl) >= single_wl_cycles
    ...
    # Check that larger workloads always return more cycles
    assert model.DMAPower(**more_kernel_wl) >= single_wl_cycles
