...
protected:
    ...
    ShaveModel1to1 modelUnroll16{VPUNN::DataType::FLOAT16,
                                 0.00030019021391918926f /*slope*/,
                                 5.661592644465712f /*intercept*/,
                                 0.0259999999999998f /*ofScalar*/,
                                 3.18080481815654f /*ofUnroll*/,
                                 8,   // vectsize
                                 16,  // unroll size
                                 1300,
                                 975};
...
TEST_F(ShaveModelSweepTest, DISABLED_ReferenceSigmoidSmoke) {
    ...
    const ShaveOpExecutor& myModel2{model.getShaveInstance(shave_name, device)};
