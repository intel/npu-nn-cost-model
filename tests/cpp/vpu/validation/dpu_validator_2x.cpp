...
class DPU_OperationValidator_TestVPU2x : public DPU_OperationValidator_Test {};

TEST_F(DPU_OperationValidator_TestVPU2x, elementwiseMemorySize_Test) {
...
TEST_F(DPU_OperationValidator_TestVPU2x, InputSparsity_and_SEP_memory_test) {
...
TEST_F(DPU_OperationValidator_TestVPU2x, OutputSparsity_and_SEP_memory_test) {
    const VPUNN::DPUWorkload wl_ref_18x18x64{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(18, 18, 64, 1, VPUNN::DataType::UINT8)},  // input dimensions
...
TEST_F(DPU_OperationValidator_TestVPU2x, Output_sparsity_memory_computation_test) {
...
TEST_F(DPU_OperationValidator_TestVPU2x, convolutionMemorySize_Test) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
...
TEST_F(DPU_OperationValidator_TestVPU2x, HALOconvolutionMemorySize_SmokeTest) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(14, 14, 512, 1, VPUNN::DataType::UINT8)},  // input dimensions
...
TEST_F(DPU_OperationValidator_TestVPU2x, InputHALOTest) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(64, 64, 512, 1, VPUNN::DataType::UINT8)},      // input dimensions
...
// value is the same
TEST_F(DPU_OperationValidator_TestVPU2x, OutputHALOTest) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(64, 64, 512, 1, VPUNN::DataType::UINT8)},      // input dimensions
...
TEST_F(DPU_OperationValidator_TestVPU2x, OutputHALO_Inbound_Test) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(64, 64, 512, 1, VPUNN::DataType::UINT8)},      // input dimensions
...
TEST_F(DPU_OperationValidator_TestVPU2x, InputHALOTest_different_H_and_W_wl) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
...
TEST_F(DPU_OperationValidator_TestVPU2x, OutputHALOTest_different_H_and_W_wl) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(64, 128, 512, 1, VPUNN::DataType::UINT8)},     // input dimensions
...
// the value of memory) and output_0_inbound_halo (this affect the value of memory)
// here are some tests for output_0_inbound_halo , for different values TBLRFB, memory value also varies
TEST_F(DPU_OperationValidator_TestVPU2x, OutputHALO_Inbound_Test_different_H_and_W_wl) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(64, 128, 512, 1, VPUNN::DataType::UINT8)},     // input dimensions
...
TEST_F(DPU_OperationValidator_TestVPU2x, Weight_sparsity_memory_test) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(64, 64, 512, 1, VPUNN::DataType::UINT8)},      // input dimensions
...
TEST_F(DPU_OperationValidator_TestVPU2x, Check_input1_and_input0_memory_when_datatype_is_diff) {
...
TEST_F(DPU_OperationValidator_TestVPU2x, Check_halo_inputs_test) {
    const VPUNN::DPUWorkload wl_ref{
            VPUNN::VPUDevice::VPU_2_7,
            VPUNN::Operation::CONVOLUTION,
            {VPUNN::VPUTensor(64, 64, 512, 1, VPUNN::DataType::UINT8)},      // input dimensions
...
TEST_F(DPU_OperationValidator_TestVPU2x, Convolution_3x3_HALOTest) {
...
TEST_F(DPU_OperationValidator_TestVPU2x, Convolution_5x5_HALOTest) {
    const VPUDevice device_req{VPUDevice::VPU_2_7};
...
TEST_F(DPU_OperationValidator_TestVPU2x, Maxpool_HALOTest) {
    const VPUDevice device_req{VPUDevice::VPU_2_7};
    const VPUNN::DPUWorkload wl_ref{
            device_req,
...
TEST_F(DPU_OperationValidator_TestVPU2x, DW_Convolution_HALOTest) {
    const VPUDevice device_req{VPUDevice::VPU_2_7};
    const VPUNN::DPUWorkload wl_ref{
            device_req,
...
TEST_F(DPU_OperationValidator_TestVPU2x, DW_Convolution_HALOTest2) {
    const VPUDevice device_req{VPUDevice::VPU_2_7};
    const VPUNN::DPUWorkload wl_ref{
            device_req,
            VPUNN::Operation::DW_CONVOLUTION,
